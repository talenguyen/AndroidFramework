...
import com.talenguyen.androidframework.R;
...
public class SwipeLayout extends FrameLayout {
    ...
    private int mMaxHorizontalDistance = 0;
     ...
     * callback's
     * {@link com.talenguyen.androidframework.views.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.talenguyen.androidframework.views.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
    ...
    public void setMaxHorizontalDistance(int maxHorizontalDistance) {
        mMaxHorizontalDistance = maxHorizontalDistance;
    }
    ...
    public static interface SwipeListener {
        ...
        /**
         * Invoke when scroll is finished
         */
    ...
    public void scrollToFinishActivity() {
        final int childWidth = mMaxHorizontalDistance == 0 ? mContentView.getWidth(): mMaxHorizontalDistance;
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if ((mTrackingEdge & EDGE_LEFT) != 0) {
                mScrollPercent = Math.abs((float) left
                        / (mMaxHorizontalDistance == 0 ? mContentView.getWidth() : mMaxHorizontalDistance));
            } else if ((mTrackingEdge & EDGE_RIGHT) != 0) {
                mScrollPercent = Math.abs((float) left
                        / (mMaxHorizontalDistance == 0 ? mContentView.getWidth() : mMaxHorizontalDistance));
            } else if ((mTrackingEdge & EDGE_BOTTOM) != 0) {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            final int childWidth = mMaxHorizontalDistance == 0 ? releasedChild.getWidth() : mMaxHorizontalDistance;
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            int ret = 0;
            if ((mTrackingEdge & EDGE_LEFT) != 0) {
                ret = Math.min(mMaxHorizontalDistance == 0 ? child.getWidth() : mMaxHorizontalDistance, Math.max(left, 0));
            } else if ((mTrackingEdge & EDGE_RIGHT) != 0) {
                ret = Math.min(0, Math.max(left, -mMaxHorizontalDistance == 0 ? child.getWidth() : mMaxHorizontalDistance));
            }
            return ret;
        }
